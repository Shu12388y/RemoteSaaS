...
const Resources = () => {
  ...
  return (
    <div>
      ...
      <article className="max-w-6xl px-6 py-24 mx-auto space-y-16 ">
            ...
            {accordionItems.map((item, index) => (
              ...
              >
                <h2 className="mb-0" id={`heading${index}`}>
                  <button 
                    className="group font-bold relative flex w-full items-center rounded-t-[15px] border-0 bg-white px-5 py-4 text-left text-base text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none  [&:not([data-te-collapse-collapsed])]:bg-white [&:not([data-te-collapse-collapsed])]:text-primary [&:not([data-te-collapse-collapsed])]:[box-shadow:inset_0_-1px_0_rgba(229,231,235)] "
                    type="button"
