        ...
        <div className="-m-6 flex flex-wrap">
          <div className="w-full p-6 md:w-1/2 lg:w-5/12">
            <div className="flex h-full flex-col justify-between">
              ...
              <p>
                Explore Thousands of Work-from-Anywhere Opportunities. Your
                Gateway to Top Remote Jobs and Careers.
              </p>
              <div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex space-x-4 mt-2">
                    {/* Facebook Icon */}
                    <a href="https://twitter.com/Lets__Code" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    ...
                    {/* Twitter Icon */}
                    <a
                      href="https://t.me/letsremotejobs"
                      target="_blank"
                    ...
                    >
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <path d="M21.949 2.316c.353.291.501.748.414 1.18l-3.092 14.579c-.095.45-.414.834-.84.988a1.575 1.575 0 01-1.252-.054l-3.979-2.047-1.784 2.893c-.294.478-.867.704-1.411.554-.545-.15-.924-.64-.93-1.206l-.027-3.57-4.447-2.026c-.444-.201-.73-.635-.72-1.115.01-.48.321-.899.775-1.062l16.03-6.22a1.216 1.216 0 011.317.197zM17.89 6.293L6.104 11.514l3.524 1.604 7.002-6.825-4.963 8.038 2.456 1.262 3.867-11.3z" />
                      </svg>
                    </a>

                    {/* LinkedIn Icon */}
                    <a
                      href="https://www.linkedin.com/company/lets-remote/"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="LinkedIn"
                    >
                    ...
                    {/* Instagram Icon */}
                    <a
                      href="https://www.instagram.com/letsremotejob/"
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              <h3 className="tracking-px mb-9 text-[20px] font-semibold uppercase text-white">
                Home
              </h3>
              <ul>
                <li className="mb-4">
