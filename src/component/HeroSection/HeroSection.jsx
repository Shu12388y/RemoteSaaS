            ...
            <div className="">
                <div className="bg-green-400 p-9">
                    <div className="flex justify-center items-center">
                        <input type="text" className="form-input border-0 w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 mr-4 mb-4 sm:mb-0" placeholder="Keyword" />
...
{/* Category section */}
            ...
            <div className="container">
                <h1 className="text-center mb-5 animate__animated animate__fadeInUp" style={{ animationDelay: '0.1s' }}>Explore By Category</h1>
...
{/* About Section */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
                    <div className="wow fadeIn" data-wow-delay="0.1s">
                        <div className="grid grid-cols-2 gap-0.5 about-bg rounded overflow-hidden">
                            ...
                            <img className="img-fluid w-full" src="img/about-2.jpg" alt="About 2" />
                            <img className="img-fluid w-full" src="img/about-3.jpg" alt="About 3" />
        ...
        <div>
          ...
          <div className='flex flex-row items-center justify-center gap-10 py-10'>
            <button className='text-bold text-xl text-black' onClick={()=>setActiveTab(<Feature data={data}/>)}>Feature</button>
            <button className='text-bold text-xl text-black' onClick={()=>setActiveTab(<FullTime data={data}/>)}>Full Time</button>
            <button className='text-bold text-xl text-black' onClick={()=>setActiveTab(<PartTime data={data}/>)}>Part Time</button>
...
<button className='bg-green-500 text-white p-4 font-bold text-md rounded-sm '>Browser More Jobs</button>
</div>
